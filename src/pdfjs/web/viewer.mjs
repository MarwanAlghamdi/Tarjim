...
{
  const HOSTED_VIEWER_ORIGINS = new Set(["null", "http://mozilla.github.io", "https://mozilla.github.io", /* ollama-ar patch: trust our own extension origin */ URL.parse(window.location)?.origin ?? "null"]);
